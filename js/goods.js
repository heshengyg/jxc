...
// ===================== 【文件最末尾唯一一份单位代码，适配index现有unitAllModal弹窗】 =====================
// 全局缓存（仅声明一次，无重复变量）
let baseUnitList = [];
let unitSpecList = [];
let baseUnitPage = 1;
...
// ========== 统一弹窗函数（适配你index唯一 #unitAllModal，无baseUnitModal/unitSpecModal依赖 ==========
/**
 * 打开弹窗：type=1最小单位 / type=2换算规格
 */
...
// 全局导出所有页面onclick需要的函数（完全匹配index按钮）
